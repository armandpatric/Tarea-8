...
plot(p, entropies, type = 'l', col = 'black', xlab = 'Valores de probabilidad p', ylab = 'Entropía de la función', main = 'Variación de la entropía contra p', ylim = range(c(0, entropies, theoretical), finite = TRUE))
lines(p, theoretical, col = 'blue')
...
La variable aleatoria geométrica modela el número de ensayos independientes e idénticos necesarios para obtener el primer éxito en una secuencia de ensayos de Bernoulli con probabilidad de éxito $p$. Si denotamos esta variable aleatoria como $X$, su función de masa de probabilidad (PMF) es:
